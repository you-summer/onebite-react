...
function printClickEventLogs(logs) {
  // 여기에 코드를 작성하세요 ...
    logs.forEach(function(item, idx, arr){
        if(item.type === "click"){
...
function getSortedBooks(books) {
  ...
  books.sort(function(a,b){
    // console.log(a) // 웹프론트,이펙티브,클린코드
    // console.log(b) // 한입리액트,웹프론트,이펙티브
    let timeStampA = a.published.getTime();
    let timeStampB = b.published.getTime();
